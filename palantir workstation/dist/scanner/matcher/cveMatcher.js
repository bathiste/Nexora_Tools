...
exports.CVEMatcher = void 0;
const events_1 = require("events");
class CVEMatcher extends events_1.EventEmitter {
    constructor(db) {
        super();
     ...
     */
    async match(scanId, technologies, config) {
        this.reset();
        const results = [];
     ...
     */
    async findCVEsForTechnology(technology, version) {
        const cves = [];
        // Query database for CVEs matching this technology
        const result = await this.db.query(`SELECT c.* FROM gotham.cves c
     ...
     */
    deduplicateTechnologies(technologies) {
     ...
     */
    isVersionAffected(detectedVersion, affectedRange) {
        ...
        if (rangeMatch) {
            return (this.compareVersions(detected, rangeMatch[1]) >= 0 &&
     ...
     */
    calculateConfidence(detectedVersion, cve) {
...
exports.CVEMatcher = CVEMatcher;
exports.default = CVEMatcher;
